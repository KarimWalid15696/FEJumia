...
import com.PhoneNumbers.springboot.model.MozambiqueCustomer;
...
class PhoneNumbersApplicationTests {
	...
	void findAllTest() throws Exception
	{
		...
		MozambiqueCustomer customer1 = new MozambiqueCustomer(1,"Karim","02584",null,null);
		MozambiqueCustomer customer2 = new MozambiqueCustomer(2,"Karim","025484",null,null);
		MozambiqueCustomer customer3 = new MozambiqueCustomer(3,"Karim","0258344",null,null);
		...
		assertEquals(customer1.getCountry(),customers.get(0).getCountry());
		assertEquals(customer2.getPhone(),customers.get(1).getPhone());
		assertEquals(customer3.getName(),customers.get(2).getName());
	...
	void getValidCustomers() throws Exception
	{
		...
		//test phone number
		assertEquals("633963130", customers.get(0).getPhone());
		//test validity
